...
function getPourcentage(){
	var url = "http://localhost:8080/SanteWeb/PourcentageServlet?id="+idAnalyse;
...
{  
   var url = "http://localhost:8080/SanteWeb/UpdateAnalyse?id="+idAnalyse;
...
function load(chart)  
{  
   var url = "http://localhost:8080/SanteWeb/SelectAnalyse?id="+idAnalyse;//use any url that have json data  
   var request;  
