...
/**
 * Servlet implementation class ModifMaladie
 */
@WebServlet("/ModifMaladie")
public class ModifMaladie extends HttpServlet {
	@EJB
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		h.updateMaladie(id,designation, tension, glycemie, bcm, fer, magnesium);
